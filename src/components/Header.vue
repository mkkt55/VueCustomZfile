<template>
    <el-form :inline="true" class="demo-form-inline zfile-header" size="mini">
        ...
        <!-- 
        <el-button style="float: right" type="primary" @click="uploadFiles" icon="el-icon-upload2" size="medium">上传</el-button>
        <el-button style="float: right" type="primary" @click="downloadFiles" icon="el-icon-download" size="medium">下载</el-button>
        <el-button style="float: right" type="primary" @click="copyFiles" icon="el-icon-upload2" size="medium">复制到这里</el-button>
        <el-button style="float: right" type="primary" @click="moveFiles" icon="el-icon-download" size="medium">移动到这里</el-button>
        <el-button style="float: right" type="primary" @click="createNewDir" icon="el-icon-upload2" size="medium">创建新文件夹</el-button>
        <el-button style="float: right" type="primary" @click="clearSelection" icon="el-icon-download" size="medium">清除选择</el-button>
        <el-button style="float: right" type="primary" @click="selectAll" icon="el-icon-download" size="medium">全选本页</el-button>
        <el-button style="float: right" type="primary" @click="selectAllFiles" icon="el-icon-download" size="medium">全选文件</el-button>
         -->
    </el-form>
</template>
